...
const translations = {
  en: {
    ...
    createPaymentInfo: "Create Payment Info",
  ...
  gr: {
    ...
    loginTitle: "Τίτλος Σελίδας Σύνδεσης",
    ...
    needToRegister: "Χρειάζεστε να εγγραφείτε;",
    ...
    paymentsTab: "Πληρωμές",
    managePayments: "Διαχείριση Πληρωμών",
    createPaymentInfo: "Δημιουργία Πληροφοριών Πληρωμής",
    studentName: "Όνομα Φοιτητή",
    bidAmount: "Ποσό Προσφοράς",
    iban: "IBAN",
    paypal: "PayPal",
    stripe: "Stripe",
